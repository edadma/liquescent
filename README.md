...
[![Version](https://img.shields.io/badge/latest_release-v0.2_snapshot_6-orange.svg)](https://github.com/edadma/liquescent/releases/tag/v0.2_snapshot_6)
...
```bash
echo "{{ v | join: \", \" }}" | java -jar liquescent-0.2_snapshot_6.jar -j "{v: [\"one\", \"two\", \"three\"]}" --
```
...
<dependency>
  ...
  <version>0.2_snapshot_6</version>
</dependency>
```
...
libraryDependencies += "xyz.hyperreal" %% "liquescent" % "0.2_snapshot_6"
```
